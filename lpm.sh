...
usage () {
    ...
    echo -e "${UNDERLINE}Examples:${EC}"
    echo -e "\n\t1) $0 -l d152a-lpm-lpar1 --sourcecec d152a --targetcec d120a --sourcehmc 9.3.147.165"
    echo -e "\n\t2) $0 -l d152a-lpm-lpar2 --sourcecec d120a --targetcec d152a --sourcehmc 9.3.147.165 -i 10 -w 5m"
    echo -e "\n\t3) $0 -l d152a-lpm-lpar3 --sourcecec d152a --targetcec d120a --sourcehmc 9.3.147.165 --targethmc 9.3.147.156 -r\n"
